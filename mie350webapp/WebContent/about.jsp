	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-8 text-left">
				...
				the quiz or can be accessed from the <a href = "searchStudent.jsp">search page</a>.
				...
				which they can view in the <a href = "contact.jsp">"My Workspace" page</a>, where they 
				<!-- TODO: make sure this points to the my workspace page--> 
				can add and delete products from their <a href = "contact.jsp">favourites list</a> and
				<!-- TODO: make sure this points to the favourites list page-->
				<a href = "contact.jsp">create or update</a> their account 
